...
<div class="container-fluid page-body-wrapper">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#post-management" aria-expanded="false" aria-controls="ui-basic">
            ...
            <div class="collapse" id="post-management">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Category</a></li>
              </ul>
            </div>
        </li>
        {{-- <li class="nav-item">
